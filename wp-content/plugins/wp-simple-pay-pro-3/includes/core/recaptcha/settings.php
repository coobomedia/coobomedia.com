...
function setup_description() {
	...
	echo wp_kses_post(
		sprintf(
			...
			__( 'Google reCAPTCHA is a free anti-spam service from Google which helps to protect your website from spam and abuse while letting real people pass through with ease. To enable reCAPTCHA %1$sregister your site with Google%2$s with reCAPTCHA v3 to retrieve the necessary credentials.', 'simple-pay' ),
	...
	<p>
		<a href="https://www.google.com/recaptcha/admin/create" target="_blank" rel="noopener noreferrer"  class="button button-secondary">
			<?php
			esc_html_e( 'Sign Up for reCAPTCHA v3', 'simple-pay' );
			?>
		</a>
	</p>
