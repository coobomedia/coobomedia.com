...
function row_actions( $actions, $post ) {
	...
	if ( isset( $actions['view'] ) ) {
		...
		if ( 'yes' !== $payment_page_enabled ) {
			...
			$actions['view'] = sprintf(
				...
				esc_html__( 'View Payment Page', 'simple-pay' )
			);
		}
	}
	...
	$actions = simpay_add_to_array_after(
		...
		(
			...
			esc_html__( 'Duplicate', 'simple-pay' ) .
			'</a>'
		),
		'simpay-preview',
		$actions
...
function add_livemode_column( $columns ) {
	$columns = simpay_add_to_array_after(
		'livemode',
		'<span class="screen-reader-text">' . esc_html__( 'Payment Mode', 'simple-pay' ) . '</span>',
		'title',
		$columns
	);
...
function add_shortcode_column( $columns ) {
	$columns = simpay_add_to_array_after(
		'shortcode',
		esc_html__( 'Shortcode', 'simple-pay' ),
		'livemode',
		$columns
	);
