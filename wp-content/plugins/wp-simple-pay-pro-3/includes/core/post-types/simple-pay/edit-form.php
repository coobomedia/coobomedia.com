		...
		array(
			...
			'i18n'        => array(
				'valid'   => sprintf(
					...
					esc_html__( 'Additional protection enabled!', 'simple-pay' )
				),
				'invalid' => sprintf(
					'<span class="dashicons dashicons-shield"></span> %s',
					esc_html__( 'Invalid configuration — missing additional protection!', 'simple-pay' )
				),
			),
			...
			<div style="margin: 4px 0 0;">
				<div style="display: flex; align-items: center;">
					<label for="_recaptcha" class="simpay-field-bool">
						...
						<?php esc_html_e( 'Google reCAPTCHA v3', 'simple-pay' ); ?>
					</label>
				</div>
				<p class="description">
					<?php
					...
					<span class="simpay-recaptcha-payment-form-feedback">
						<?php if ( $recaptcha ) : ?>
							...
							<?php esc_html_e( 'Verifying credentials…', 'simple-pay' ); ?>
						<?php else : ?>
