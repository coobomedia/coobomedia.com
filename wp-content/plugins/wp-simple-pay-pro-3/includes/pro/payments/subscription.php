...
function retrieve( $subscription, $api_request_args = array() ) {
	...
	return Subscriptions\retrieve( $subscription, $api_request_args );
}
...
function all( $subscriptions = array(), $api_request_args = array() ) {
	...
	return Subscriptions\all( $subscriptions, $api_request_args );
}
...
function create( $subscription_args = array(), $api_request_args = array() ) {
	...
	return Subscriptions\create( $subscription_args, $api_request_args );
}
...
function get_args_from_payment_form_request(
	...
	$subscription_args['items'] = array_values( $items );
...
function get_setup_fee_from_payment_form_request(
	...
	if ( ! empty( $plan_fee_args ) ) {
		$line_items[] = $plan_fee_args;
	}
